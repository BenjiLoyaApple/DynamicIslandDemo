...
class LiveActivityManager {
    ...
    static func startActivity(
        ...
        let initialState =
        FoodDeliveryAttributes.ContentState(arrivalTime: arrivalTime, phoneNumber: phoneNumber, restaurantName: restaurantName, customerAddress: customerAddress)
    ...
    static func listAllActivities() -> [[String:String]] {
        ...
        Activity<FoodDeliveryAttributes>.activities.sorted{ $0.id > $1.id }
